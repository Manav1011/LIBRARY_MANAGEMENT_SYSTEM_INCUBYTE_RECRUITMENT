...
class TestMultiplyFunction(unittest.TestCase):
    ...
    def test_return_type_is_boolean(self):
        self.result = self.LMS.add_book('dummy-isbn','Test Book','Test Author',2024)
    ...
    def test_check_for_null_values(self):
        ...
        self.assertEqual(str(e.exception),'parameters_missing')
    ...
    def test_minimum_title_length(self):
        ...
        with self.assertRaises(Exception) as e:
            self.LMS.add_book('dummy-isbn','Test Book','Test Author',2024)
        self.assertEqual(str(e.exception),'title_lenght_too_low')
